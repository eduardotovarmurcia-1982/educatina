...
<head>
    ...
    <style>
        /* Configuración de la fuente global y fondo oscuro */
        ...
        body {
            ...
            /* Fondo negro profundo para el contraste neón */
            background-color: var(--bg-dark); 
            color: #d1d5db; /* Texto gris claro general */
        }
        /* Clase para el efecto de brillo neón en el texto */
        .text-neon-glow {
            text-shadow: 0 0 5px var(--neon-color), 0 0 10px var(--neon-color);
            color: var(--neon-color);
        }
        /* Clase para el efecto de borde/sombra neón en elementos interactivos */
        .border-neon-glow {
            box-shadow: 0 0 10px rgba(232, 121, 249, 0.6); /* Sombra morada semi-transparente */
            border-color: var(--neon-color);
        }
        /* Animación de pulso sutil para el título */
        ...
        /* Estilos para el borde dinámico del menú */
        ...
        /* Estilo para el área de resultado del LLM */
        .llm-output {
...
<body class="min-h-screen">
    ...
    <header class="sticky top-0 z-50 bg-black bg-opacity-80 backdrop-blur-sm shadow-lg shadow-fuchsia-900/20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            <!-- Logo Educatina con efecto neón -->
    ...
    <main class="py-16 md:py-24">
        ...
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-24">
            ...
            <p class="text-xl md:text-2xl mb-10 max-w-4xl mx-auto text-gray-400">
                Plataforma educativa con tecnología de punta. Cursos impulsados por IA y experiencias inmersivas.
            </p>
            <div class="space-x-4">
        ...
        <!-- Sección de Características (Grid Futurista) -->
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-4xl font-bold mb-12 text-center text-neon-glow">Nuestros Pilares Tecnológicos</h2>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-gray-900 border border-fuchsia-800 rounded-xl p-6 transition duration-500 hover:shadow-2xl hover:shadow-fuchsia-700/50 hover:border-fuchsia-400 border-neon-glow">
                    <div class="text-5xl mb-4 text-fuchsia-400">⚡</div> <!-- Icono: Rayo / Poder -->
                    <h3 class="text-xl font-semibold mb-3 text-neon-glow">IA Tutora Personalizada</h3>
                    <p class="text-gray-400 mb-4">Algoritmos que adaptan el contenido y ritmo de estudio a tu estilo de aprendizaje único, garantizando la máxima retención.</p>
                ...
                <div class="bg-gray-900 border border-fuchsia-800 rounded-xl p-6 transition duration-500 hover:shadow-2xl hover:shadow-fuchsia-700/50 hover:border-fuchsia-400 border-neon-glow">
                    <div class="text-5xl mb-4 text-fuchsia-400">🌐</div> <!-- Icono: Globo / VR -->
                    <h3 class="text-xl font-semibold mb-3 text-neon-glow">Realidad Extendida (XR)</h3>
                    <p class="text-gray-400">Lecciones inmersivas con realidad virtual y aumentada para experimentar la física, la historia o la medicina como nunca antes.</p>
                </div>

                <!-- Tarjeta 3: Conexión Global -->
                <div class="bg-gray-900 border border-fuchsia-800 rounded-xl p-6 transition duration-500 hover:shadow-2xl hover:shadow-fuchsia-700/50 hover:border-fuchsia-400 border-neon-glow">
                    <div class="text-5xl mb-4 text-fuchsia-400">💡</div> <!-- Icono: Bombilla / Idea -->
                    <h3 class="text-xl font-semibold mb-3 text-neon-glow">Blockchain para Certificados</h3>
                    <p class="text-gray-400">Certificados a prueba de manipulaciones basados en tecnología blockchain, verificables instantáneamente por empleadores en todo el mundo.</p>
                </div>
        ...
        <!-- Sección LLM Feature 2: Asistente de Estudio Rápido -->
        <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 p-8 bg-gray-900 rounded-2xl border border-fuchsia-700 border-neon-glow">
            <h2 class="text-3xl font-extrabold mb-6 text-neon-glow text-center">✨ Asistente de Estudio Rápido IA</h2>
            <p class="text-lg mb-6 text-gray-400 text-center">Pregunta cualquier concepto técnico y obtén una explicación concisa y avanzada al instante. Ejemplo: "Explica la arquitectura Zero Trust."</p>

            <div class="flex flex-col md:flex-row gap-4 mb-4">
                <input type="text" id="tutorInput" placeholder="Escribe tu pregunta o concepto aquí..." 
        ...
        <section class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center p-12 bg-gray-900 rounded-2xl border border-fuchsia-700 border-neon-glow">
            <h2 class="text-3xl md:text-4xl font-extrabold mb-4 text-neon-glow">Únete a la Revolución Educativa</h2>
            <p class="text-lg mb-8 text-gray-400">Regístrate hoy y desbloquea el acceso a un ecosistema de conocimiento diseñado para el siglo XXI.</p>
            <form class="flex flex-col md:flex-row gap-4 justify-center">
                <input type="email" placeholder="Tu correo electrónico futurista..." 
    ...
    <footer class="bg-black py-8 mt-12 border-t border-fuchsia-900/30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-500 text-sm">
            ...
            <div class="mt-2 space-x-4">
                <a href="#" class="hover:text-fuchsia-400 transition duration-300">Términos</a>
    ...
    <script>
        // --- CONSTANTES Y CONFIGURACIÓN DEL API DE GEMINI ---
        const API_KEY = ""; // La clave se proporcionará automáticamente en el entorno de ejecución
        const MODEL = "gemini-2.5-flash-preview-09-2025";
        const API_URL = `https://generativelanguage.googleapis.com/v1beta/models/${MODEL}:generateContent?key=${API_KEY}`;
        const MAX_RETRIES = 5;

        // --- FUNCIÓN DE UTILIDAD PARA LLAMADAS AL API CON BACKOFF EXPONENCIAL ---
        ...
        document.getElementById('generateCourseIdeasBtn').addEventListener('click', async () => {
            ...
            outputDiv.innerHTML = '<div class="text-neon-glow flex items-center justify-center">Generando ideas... 🚀</div>';
            button.disabled = true;
            button.textContent = 'Generando...';

            const systemPrompt = "Actúa como un futurista y diseñador curricular. Genera 3 ideas de cursos de tecnología de vanguardia para una plataforma educativa llamada Educatina. El curso debe ser innovador y relevante para el futuro laboral.";
            const userQuery = "Genera 3 cursos avanzados sobre: (1) Desarrollo de IAs con 'Emotional Intelligence', (2) Ingeniería de prompts para 'Modelos de lenguaje masivos' (LLMs), y (3) Seguridad cibernética post-cuántica. Asegúrate de que el 'Nivel' sea 'Avanzado' o 'Experto'.";
                    ...
                    responseSchema: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                "Descripcion": { "type": "STRING", "description": "Resumen de lo que se aprenderá." },
            ...
            try {
                    ...
                    ideas.forEach((idea, index) => {
                        html += `
                            <div class="mb-3 p-3 bg-gray-800 rounded-lg">
                                ...
                                <p class="text-sm text-gray-400 mt-1">${idea.Descripcion || 'Sin descripción.'}</p>
                ...
                outputDiv.innerHTML = `<p class="text-red-400">Error IA: ${error.message}. Por favor, inténtalo de nuevo.</p>`;
            } finally {
                outputDiv.classList.remove('llm-output-loading');
                button.disabled = false;
                button.textContent = '✨ Generar Ideas de Cursos IA';
            }
        });

        // --- FEATURE 2: ASISTENTE DE ESTUDIO RÁPIDO (TEXT GENERATION) ---
        document.getElementById('tutorAskBtn').addEventListener('click', async () => {
            ...
            outputDiv.classList.add('llm-output-loading');
            outputDiv.innerHTML = '<div class="text-neon-glow flex items-center justify-center">Analizando consulta... 🧠</div>';
            button.disabled = true;
            button.textContent = 'Analizando...';

            const systemPrompt = "Actúa como un tutor experto en tecnología de nivel universitario. Tu respuesta debe ser concisa, clara y avanzada (máximo 4 frases). Responde en español.";

            const payload = {
                contents: [{ parts: [{ text: userQuery }] }],
                systemInstruction: { parts: [{ text: systemPrompt }] },
                tools: [{ "google_search": {} }] // Habilitar la búsqueda para obtener información actualizada
            };
            ...
            try {
                ...
                outputDiv.innerHTML = `<p class="text-red-400">Error IA: ${error.message}. Verifica tu conexión.</p>`;
            } finally {
                outputDiv.classList.remove('llm-output-loading');
                button.disabled = false;
                button.textContent = '✨ Preguntar a la IA';
            }
        });
